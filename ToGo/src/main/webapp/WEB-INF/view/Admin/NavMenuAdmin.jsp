...
<link type="text/css"
    ...
    <div class="container-fluid body-content" style="background-color: #1f1c3b; min-height: 100vh; overflow: hidden;">
      <div class="row">
        <div class="side-nav-content side-nav-layout " style="overflow: hidden;">
          <br><br>
          <a href="${pageContext.request.contextPath}/admin/profile" class="list-group-item" id="down-layout">
          ...
          <br>
          <a href="${pageContext.request.contextPath}/admin/showfaculty" class="list-group-item" id="down-layout">
            <span class="row-no-gutters">
              <span class="col-sm-1">
                <i class="fa fa-id-badge fa-lg"></i>
              </span>
              <span class="col-sm-offset-1"> Faculty </span>
            </span>
          </a>
