    ...
    <div class="nav navbar-inverse navbar-fixed-top">
      <div class="container-fluid" style="background-color: #1f1c3b">
        <div class="navbar-header" style="padding-left: 5%; padding-top: 5px">
          <a href="${pageContext.request.contextPath}/admin/profile" class="navbar-left" style="text-decoration: none">
            <img
        ...
        <ul class="nav navbar-nav navbar-right">
          <li>
            ...
            <li><a href="${pageContext.request.contextPath}/admin/logout" style="margin-top: 5px; margin-right:15px;">
