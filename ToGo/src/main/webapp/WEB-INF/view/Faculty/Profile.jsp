          ...
          >
            ...
            <div width="100%" align="center" style="font-family: 'Times New Roman'; font-size: 20px;padding-top: 40px; color: #e2344d ">
                ...
                <div style="text-align: left; padding-left: 10%; font-family: 'Times New Roman'; font-size: 20px; color: #25aa98">
                    ...
                    <br />
                    <strong>Designation :</strong> <span style="color: #d1c7ed;font-size: 18px; "> ${user.designation}</span>
                    <br />
                ...
                <br />
                <span>
                    <a href="${pageContext.request.contextPath}/faculty/editprofile" class="button" >Edit Profile</a>
                    &nbsp;&nbsp;
                    <a href="${pageContext.request.contextPath}/faculty/changepassword" onclick="" class="button">Change Password</a>
