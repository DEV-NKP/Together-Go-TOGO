    ...
    <div align="center" style="margin-left: 0px; margin-top:5%; margin-bottom: 20px;
      ...
      padding-top: 10px;
               ...
               box-shadow: 0 15px 35px 0 rgba(0,0,0,0.37); border-radius: 15px;">
                    ...
                    <form:form action="addtask" modelAttribute="task" method="POST" id="form">
                                      ...
                                      <tr>
                                          ...
                                          <td align="center" colspan="2" width="100%" style="padding-top:50px; padding-left: 0px; background-color: #303030;">
                                              <div >
                                                  ...
                                                  <a href="javascript:$('form').submit();" id="buttonGlow" style=" filter: hue-rotate(180deg); cursor: pointer;">Assign Task</a>
