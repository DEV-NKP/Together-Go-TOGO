...
<div class="nav navbar-inverse navbar-fixed-top">
  <div class="container-fluid" style="background-color: #1f1c3b">
    <div class="navbar-header" style="padding-left: 5%; padding-top: 5px">
      <a href="${pageContext.request.contextPath}/student/profile" class="navbar-left" style="text-decoration: none">
        <img
        ...
        <b class="text-muted"
          ><strong
            style="font-family: 'Helvetica'; font-size: 18px; color: #f4c2c2"
            >ToGo</strong
          ></b
        >
      </a>
