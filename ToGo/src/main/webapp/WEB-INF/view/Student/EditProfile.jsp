...
<%@ include file='HeaderStudent.jsp' %>
    ...
    <div class="container-fluid body-content" style="  height: 100%;">
     <div class="row">
        ...
        <div align="center" style="background-color: #303030; height: 600px; width: 760px;
          padding-top: 10px; padding-left: 10px; margin-top: 20px;
         padding-right: 10px; padding-bottom: 20px; border: 0px solid #808080 ; border-radius: 15px; box-shadow: 0 15px 35px 0 rgba(0,0,0,0.37);">
        
             <br />

            <form:form action="editprofile" modelAttribute="student" method="POST" id="form">
                 <table style="margin-top: -20px;">
                     <tr>
                         ...
                         <td width="100%" align="" style="background-color: #303030; padding-top:30px;">
                             <table width="660px" >
                                 <tr>
                                     <td colspan="2" width="80%" align="center" style="background-color: #303030; padding-left:10px; padding-top:10px; padding-bottom:25px;">
                                 ...
                                 <tr>
                                     <td width="50%" style="padding-left: 0px; background-color: #303030;">
                                         ...
                                         <form:input path="studentID" type="text" name="studentId" value="" class="form-control" id="text-box-normal" style="width:300px" readonly="true"/>
