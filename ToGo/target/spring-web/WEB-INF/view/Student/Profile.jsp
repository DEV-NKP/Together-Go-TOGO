        ...
        <div class="row">
          ...
          >
            ...
            <div width="100%" align="center" style="font-family: 'Times New Roman'; font-size: 20px; padding-top: 40px; color: #e2344d ">
                ...
                <img src="${pageContext.request.contextPath}/Image/white.png" title="Profile" class="img-circle hover-profile" width="15%" height="15%" style="padding: 10px;" />
                <br /><br />
                ...
                <div style="text-align: left; padding-left: 10%; font-family: 'Times New Roman'; font-size: 20px; color: #25aa98">
                    ...
                    <br />
                    <strong>Student ID &nbsp; : </strong><span style="color:#d1c7ed; font-size: 18px;">  ${user.studentId}</span>
                    <br />
                ...
                <br />
                <span>
                    <a href="${pageContext.request.contextPath}/student/editprofile" class="button" >Edit Profile</a>
                    &nbsp;&nbsp;
                    <a href="${pageContext.request.contextPath}/student/changepassword" onclick="" class="button">Change Password</a>
