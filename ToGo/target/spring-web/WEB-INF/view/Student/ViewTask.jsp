    ...
    <div class="container-fluid body-content" style="height: 100%;">
      <div class="row">
        ...
        <div align="left" style="margin-top:20px; padding-left: 40px; ">
          <a href="${pageContext.request.contextPath}/student/viewtasktable"
      ...
      background-color: #303030; height: 750px; width: 760px;
      padding-top: 10px;
               ...
               box-shadow: 0 15px 35px 0 rgba(0,0,0,0.37); border-radius: 15px;">
                ...
                <form:form action="viewtask" modelAttribute="task" method="POST" id="form">
...
justify-content: center;"
        ...
        "
                    ...
                    <form:textarea path="task" type="text" name="task" value="" class="form-control" id="text-box-normal" style="margin-left: 0px; min-width: 630px; min-height: 60px; max-height:60px;" />
                    ...
                    <!--   <textarea rows="5" cols="100" class="form-control" id="text-area-normal" style="margin-left: -20px; min-width: 500px; min-height: 60px; max-width: 500px; max-height:60px;"></textarea>
                                      ...
                                      <tr>
                                          ...
                                          <td align="center" colspan="2" width="100%" style="padding-top:50px; padding-left: 0px; background-color: #303030;">
                                              <div >
                                                  <!--<input type="submit" class="btn btn-success" id="button-glow" />-->
                      
                                                  <a href="javascript:$('form').submit();" id="buttonGlow" class="clickbutton" style=" filter: hue-rotate(180deg); cursor: pointer;">Submit Task</a>
