    ...
    <div class="container-fluid body-content" style="  height: 100%;">
     <div class="row">
          ...
          <div align="left" style="margin-top:15px; padding-left: 40px; ">
              <c:url var="facultyLink" value="facultyprofile">
        ...
        <div align="center" style="background-color: #303030; height: 620px; width: 760px; 
         ...
         padding-right: 10px; padding-bottom: 20px; border: 0px solid #808080 ;
          border-radius: 15px; box-shadow: 0 15px 35px 0 rgba(0,0,0,0.37);">
            ...
            <form:form action="editprofilefaculty" modelAttribute="faculty" method="POST" id="form">
                                ...
                                <!--   <label for="file" id="buttonGlow" style="cursor: pointer; font-size:12px">Select Image</label>
                                 ...
                                 <tr >
                                     ...
                                     <td width="50%" style="padding-left: 20px; background-color: #303030;">
                                         <h6 style="font-weight: lighter; padding-top: 0px; color: #c9c9c9; margin-left: 20px;">
                                             Last Name:
                                         </h6>
                                 ...
                                 <tr>
                                     ...
                                     <td width="50%" style="padding-left: 20px; background-color: #303030;">
                                        <h6 style="font-weight: lighter; color: #c9c9c9; margin-left: 20px;">
                                         ...
                                         <form:input path="email"  name="email" value="" class="form-control" id="text-box-normal" style="width:300px" readonly="true"/>
                                 ...
                                 <tr>
                                    <td width="50%" style="padding-left: 0px; background-color: #303030;">
                                        ...
                                        <form:input path="designation" type="text" name="designation" value="" class="form-control" id="text-box-normal" style="width:300px"/>
