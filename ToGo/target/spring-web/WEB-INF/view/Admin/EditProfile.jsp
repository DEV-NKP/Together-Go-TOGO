...
<%@ include file='HeaderAdmin.jsp' %>
    ...
    <div class="container-fluid body-content" style="  height: 100%;">
     <div class="row">
        ...
        <div align="center" style="background-color: #303030; height: 580px; width: 760px; 
         ...
         padding-right: 10px; padding-bottom: 20px; border: 0px solid #808080 ;
          border-radius: 15px; box-shadow: 0 15px 35px 0 rgba(0,0,0,0.37);">
            ...
            <form:form action="editprofile" modelAttribute="admin" method="POST" id="form">
                         ...
                         <td width="100%" align="" style="background-color: #303030; padding-top:20px;">
                             <table width="660px" >
                                 ...
                                 <tr >
                                     ...
                                     <td width="50%" style="margin-left: 40px; background-color: #303030;">

                                         <h6 style="font-weight: lighter; color: #c9c9c9; margin-left: 20px;">
                                             First Name:
                                         </h6>
                                     ...
                                     <td width="50%" style="margin-left: 0px; background-color: #303030;">
                                         ...
                                         <form:input path="lastName" type="text" name="LAST_NAME" value="" class="form-control" id="text-box-normal"  style="width:300px"/>
                                 ...
                                 <tr>
                                     <td width="50%" style="margin-left: 40px; background-color: #303030;">
                                         ...
                                         <form:input path="adminId" type="text" name="adminId" value="" class="form-control" id="text-box-normal"  style="width:300px" readonly="true"/>
