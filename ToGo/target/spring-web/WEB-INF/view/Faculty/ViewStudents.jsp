    ...
    <div class="container-fluid body-content" style="  height: 100%;">
      ...
      onMouseOut="this.style.color='#6495ed'">
        ...
        <h4>All Student Details</h4>
            <h6 style="color:#888888; padding-top: 20px">Total: ${msg} Total Students</h6>
        ...
        <table class="user_table" width="95%">
          ...
          <tbody class="table-body" >
              ...
              <c:forEach var="student" items="${students}">
                  ...
                  <c:url var="removeLink" value="removestudent">
                  ...
                  <tr>
                      ...
                      <td >
                          <a href="${removeLink}"  style="white-space: nowrap;text-decoration: none;width:120px; cursor: pointer;"class="button">Remove Student</a>
                      </td>
        ...
        <div
            ...
            <div class="row>">
              ...
              <a href="${pageContext.request.contextPath}/faculty/viewstudents" class="list-group-item" id="right-layout-default">
                <span class="row-no-gutters">
