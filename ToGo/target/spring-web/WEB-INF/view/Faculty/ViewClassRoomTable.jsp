    ...
    <div class="container-fluid body-content" style="  height: 100%;">
      <div class="row">
        ...
        <hr style="height: 2px; background-color: #fa6e6d; border: none;" />
            <br>
        <table class="user_table" width="95%" style="width: 95%; overflow: scroll">
          <thead>
              <tr>
                  <th>Room No</th>
                  <th>Faculty ID</th>
          ...
          <c:forEach var="classroom" items="${classrooms}">
              ...
              <tr>
                  <td style="word-break:break-all;"> ${classroom.roomNo}</td>
                  ...
                  <td >
                      <a href="${viewlink}" style="text-decoration: none; white-space: nowrap;width:150px;  cursor: pointer;"class="button">View Classroom</a></td>
              </tr>
          </c:forEach>
        ...
        <div class="row>">
          <a href="${pageContext.request.contextPath}/faculty/viewclassroomtable" class="list-group-item" id="right-layout-default">
          ...
          <a href="${pageContext.request.contextPath}/faculty/addclassroom" class="list-group-item" id="right-layout">
            <span class="row-no-gutters">
